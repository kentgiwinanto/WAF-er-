		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-9" style="padding-left: 0px;">
					<div class="col-md-4">
						<div class="well" onmouseover="style.color='grey'" onmouseout="style.color=''" onclick="location.href='Detail';" style="cursor: pointer;border-radius: 8px;background-color: #ffffff;padding-top: 0px; padding-left: 3px;">
					...
					<div class="col-md-4" >
						<div class="well" onmouseover="style.color='grey'" onmouseout="style.color=''" onclick="location.href='Detail';" style="cursor: pointer;background-color: 
