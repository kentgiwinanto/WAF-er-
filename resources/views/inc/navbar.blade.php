	...
	<div class="container">
		<div class="row">
			<div class="col-md-10">
				...
				<li role="presentation"><a style="text-align: center;" role="menuitem" tabindex="-1" href="#"> <?php session()->get('Username'); ?> </a></li>
				<li role="presentation"><a style="text-align: center;" role="menuitem" tabindex="-1" href="#"> <?php session()->get('UserJobName'); ?> </a></li>
